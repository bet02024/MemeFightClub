...
public class DefaultJoinGameScreen : JoinGameScreen {
    ...
    public void JoinGame(Text matchNameTxt) 
    {
        if (this.connectionStatus != null) {
            this.connectionStatus.text = "Joining Game..." + this.matchName;
        }

        FindAndJoin(this.name);
    }

    public void SpectateGame(Text matchNameTxt)
    {
        if (this.connectionStatus != null) {
            this.connectionStatus.text = "Finding Game...";
        }
        FindAndSpectate(this.name);  
    }
