...
public class UFE : MonoBehaviour, UFEInterface
{
	...
	public static MultiplayerAPI onlineMultiplayerAPI;
	...
	public static int randomPlayer2 { get; set; }

	public static string address1 { get; set; }

	public static string address2 { get; set; }

	public static string addressFull1 { get; set; }

	public static string addressFull2 { get; set; }
	...
	protected void Awake(){
		...
		UFE.SetSoundFXVolume(PlayerPrefs.GetFloat(UFE.SoundsVolumeKey, 0.8f));
    }
